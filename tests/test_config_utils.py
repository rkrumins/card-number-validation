...
def test_should_load_valid_yaml_file_successfully():
    test_config_file_path = os.path.join(module_path, "test_data/test_config.yml")
...
def test_should_raise_file_not_found_exception_for_invalid_input_path():
    test_config_file_path = os.path.join(module_path, "test_data/non_existant_path.yml")
